        ...
        <div class="container">
            <div class="footer__inner">
                <div class="footer__logo">
                    <img class="logo__img img-footer" src="./assets/icons/Raccoons-shop.svg" alt="Logo">
                ...
                <a class="footer__copyright" href="https://github.com/Iuliia-Bogdanova" target="_blank">© Iuliia Bogdanova, 2023</a>
            </div>
        </div>
    </footer>
